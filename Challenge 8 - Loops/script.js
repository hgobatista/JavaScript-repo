...
(bills + tip) for every bill value in the bills array.
Use a for loop to perform the 10 calculations!

TEST DATA: 22, 295, 175, 440, 37, 105, 10, 1100, 86
and 52;
...
this before). Here is how to solve it:
    4.1. First, you'll need to add up all values in
...
const avgTips = calcAverage(tips);
